							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="{{ asset('storage/storage/avatar/'.$product->prod_img) }}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<select required name="status" class="form-control">
											<option value="1"@if($product->prod_status==1) checked @endif> Con hang</option>
									...
									<div class="form-group" >
										...
										<script type="text/javascript">
											var editor = CKEDITOR.replace('description',{
												language:'vi',
												filebrowserImageBrowseUrl: '../../backend/giaodien/ckfinder/ckfinder.html?Type=Images',
												filebrowserFlashBrowseUrl: '../../backend/giaodien/ckfinder/ckfinder.html?Type=Flash',
												filebrowserImageUploadUrl: '../../backend/giaodien/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
									...
									<div class="form-group" >
										...
										Có: <input type="radio" name="featured" value="1" @if ($product->prod_featured ==1)selectend @endif>
										Không: <input type="radio" checked name="featured" value="0" @if ($product->prod_featured ==0)selectend @endif>
									</div>
