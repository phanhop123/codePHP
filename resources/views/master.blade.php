...
<script type="text/javascript" src="/layout/backend/giaodien/ckeditor/ckeditor.js"></script>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{ asset('admin/product') }}"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Sản phẩm đặt hàng </a></li>
			<li role="presentation" class="divider"></li>
		</ul>
